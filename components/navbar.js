...
import { Search, Menu, ShoppingCart, User, LogOut, Sun, Moon, Globe, DollarSign } from "lucide-react"

export function Navbar() {
  const { language, currency, theme, user, cart, toggleLanguage, toggleCurrency, toggleTheme, logout } = useApp()
